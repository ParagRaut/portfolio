...
- ComicsApi - It is quite similar to above project, the only difference is it's an webapi and written using C# & Golang.</br>
  Check it out live here: [ComicsApi](https://random-comics-api.herokuapp.com/index.html)
